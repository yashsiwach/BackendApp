...
public class WalletServiceImplTests
{
    ...
    public void SetUp()
    {
        ...
        _service = new WalletServiceImpl(options, _uowMock.Object, _busMock.Object, _loggerMock.Object);
    }
    ...
    public async Task TransferAsync_WhenSenderLocked_ThrowsInvalidOperationException()
    {
        ...
        Func<Task> act = async () => await _service.TransferAsync(userId, new TransferRequestDto { Amount = 100m, ToUserId = Guid.NewGuid() });
    ...
    public async Task TransferAsync_WhenIdempotencyKeyExists_ReturnsExistingTransfer()
    {
        ...
        var result = await _service.TransferAsync(userId, new TransferRequestDto { Amount = 500m, IdempotencyKey = "t-key123", ToUserId = Guid.NewGuid() });
    ...
    public async Task TransferAsync_ValidRequest_ShouldProcessTransferAndPublishEvent()
    {
        ...
        var receiverWallet = new WalletAccount { Id = receiverWalletId, UserId = toUserId, SnapshotBalance = 1000m, KYCVerified = true };
        ...
        var result = await _service.TransferAsync(userId, new TransferRequestDto { Amount = 1000m, ToUserId = toUserId, IdempotencyKey = "t-key123" });
