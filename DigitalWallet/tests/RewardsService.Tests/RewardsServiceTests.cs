...
public class RewardsServiceTests
{
    ...
    public void SetUp()
    {
        ...
        _service = new RewardsServiceImpl(options, _uowMock.Object, _busMock.Object, _loggerMock.Object);
    }
    ...
    public async Task EarnPointsAsync_WhenNoActiveRule_ShouldDoNothing()
    {
        ...
        await _service.EarnPointsAsync(Guid.NewGuid(), 1000m, "TopUp", Guid.NewGuid(), "TopUp reward");

        _accountsMock.Verify(a => a.FindByUserIdAsync(It.IsAny<Guid>()), Times.Never);
