...
public class RewardsServiceImpl : IRewardsQueryService, IRedemptionService, IPointsEarningService
{
    ...
    /// <summary>Finds the rewards account for a user and throws when it is missing.</summary>
